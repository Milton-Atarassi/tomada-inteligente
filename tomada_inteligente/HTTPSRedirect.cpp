...
void HTTPSRedirect::fetchData(bool disp, bool header) {
  ...
  while (connected()) {
    ...
    if (strstr(p, "1:true") != NULL) tomada1 = true;
    if (strstr(p, "1:false") != NULL) tomada1 = false;
    
    if (strstr(p, "2:true") != NULL) tomada2 = true;
    if (strstr(p, "2:false") != NULL) tomada2 = false;
    
    if (strstr(p, "3:true") != NULL) tomada3 = true;
    if (strstr(p, "3:false") != NULL) tomada3 = false;
...
bool HTTPSRedirect::isTomada1On() {
  return tomada1;
}

bool HTTPSRedirect::isTomada2On() {
  return tomada2;
}

bool HTTPSRedirect::isTomada3On() {
  return tomada3;
}
